...
EXPENSE_SUBCATEGORIES: dict[str, list[str]] = {
    ...
    "Зарплатный фонд": ["Оклад", "Премии", "Прочее"],
    "Внешние исполнители": ["Разработка", "Дизайн", "Маркетинг", "Логистика", "Прочее"],
...
PAYROLL_EXPENSE_CATEGORIES = {"Зарплатный фонд"}
CONTRACTOR_EXPENSE_CATEGORIES = {"Внешние исполнители"}
...
EXPENSE_CATEGORY_MARKERS: dict[str, tuple[str, ...]] = {
    ...
    "Аренда": ("аренд",),
    "Зарплатный фонд": ("зарплат", "оклад", "аванс сотруд", "преми"),
    "Внешние исполнители": ("фрилан", "подряд", "исполнитель", "внешн"),
...
EXPENSE_SUBCATEGORY_MARKERS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("Аренда", "Офис"): ("офис",),
    ("Аренда", "Склад"): ("склад",),
    ("Зарплатный фонд", "Оклад"): ("оклад",),
    ("Зарплатный фонд", "Премии"): ("преми",),
