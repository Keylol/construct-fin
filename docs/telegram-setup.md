...
|---|---|---|
| Token (актуальный, после ротации 2026-05-03) | `8294880190:AAGzVE8RtNFmN7vvkYRZAfloQfrUudLboNQ` | `.env` локально, `gh secret list -R Keylol/construct-fin` на CI, `/srv/construct/app/.env` на VPS |
