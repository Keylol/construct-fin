 ...
 * через register() — каждый сам, при старте модуля, и только если настроен
 * (Альфе, например, нужен клиентский сертификат mTLS). Реестр про провайдеров
 * ничего не знает. Пока адаптера нет:
