...
/// Раздел склада (enum WarehouseSection в schema.prisma) — группировка на экране.
export const WarehouseSectionSchema = z.enum([
  'CASE',
  'MOTHERBOARD',
  'PSU',
  'GPU',
...
export const CreateWarehouseItemSchema = z.object({
  ...
  section: WarehouseSectionSchema.nullable().optional(),
