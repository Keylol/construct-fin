      ...
      <ModalContent hideClose>
        ...
        <ModalBody className="space-y-4">
          ...
          <Checkbox
            ...
            hint="Начальный остаток будет выведен из этой цифры по книге и неразобранным строкам; синк банка его больше не перезапишет. Выписка по счёту должна быть загружена по эту дату."
            checked={anchor}
