...
/**
 * Один вход для всех экранов: пока список организаций грузится — скелетон
 * страницы; упал — честная ошибка с «Повторить»; организаций нет — «создайте
 * первую». Раньше каждый экран нёс свою копию блока «Нет активного
 * пространства» и показывал её и на загрузке, и на ошибке, и когда
 * организаций правда нет — три разных ситуации одним текстом.
 *
      ...
      <>
        <div className="p-6">
          <EmptyState
            ...
            hint="Организация — это один бизнес: свои счета, заказы и отчёты."
            action={
