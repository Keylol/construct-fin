...
- **Прод:** VPS 195.133.1.13 (RUVDS, Королёв), https://constructfin.aleksandrantropov.ru (прямой адрес, без Cloudflare; TLS до 14.12.2026). Старый `miniapp.aleksandrantropov.online` снят 19.09.2026 — часть провайдеров РФ резала диапазоны Cloudflare. Деплой = push в `v6` (см. ветвление выше).
