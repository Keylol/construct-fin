...
- **Прод:** VPS 195.133.1.13 (RUVDS, Королёв); два адреса на один стек — https://miniapp.aleksandrantropov.online (за Cloudflare, TLS до 04.11.2026) и https://constructfin.aleksandrantropov.ru (прямой, в обход Cloudflare — часть провайдеров РФ режет её диапазоны; добавлен 15.09.2026, TLS до 14.12.2026); подробности `docs/deploy.md` «Два адреса». Деплой = push в `v6` (см. ветвление выше).
